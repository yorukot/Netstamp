...
cp .env.example .env
chmod 600 .env
# Fill LOG_PSEUDONYM_KEY, SYSTEM_SETTINGS_ENCRYPTION_KEY, DATABASE_PASSWORD, AUTH_SESSION_HASH_KEY, and AUTH_API_TOKEN_HASH_KEY with unique values generated by `openssl rand -hex 32`.
docker compose up -d
```
