...
The observability compose stack serves Grafana behind the dashboard host at `/grafana/`.

| Variable           | Purpose                                     | Default                                   |
| ------------------ | ------------------------------------------- | ----------------------------------------- |
| `BACKEND_BASE_URL` | Public controller origin for generated URLs | `https://dashboard.netstamp.dev`          |
| `GRAFANA_DOMAIN`   | Grafana public domain                       | `dashboard.netstamp.dev`                  |
| `GRAFANA_ROOT_URL` | Grafana public root URL                     | `https://dashboard.netstamp.dev/grafana/` |
