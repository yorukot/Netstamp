...
The release `env.example` file contains the required secrets and production URL settings. Copy it to `.env`, then add only the overrides you need from this page.
