...
<ProductScreenshot src={createProjectScreenshot} alt="Create project dialog in the Netstamp project switcher" caption="Create a dedicated project before adding probes and checks." />
