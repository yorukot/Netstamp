...
If you are unsure where a change belongs, describe the intended user behavior in a [GitHub issue](https://github.com/yorukot/netstamp/issues). For sensitive security reports, follow [Security operations](/docs/operate/security/) instead of opening a public issue.
