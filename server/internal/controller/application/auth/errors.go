...
var (
	...
	ErrAccountCreationDisabled       = errors.New("account creation is disabled")
	ErrCredentialChangesDisabled     = errors.New("credential changes are disabled")
	ErrInstancePolicyUnavailable     = errors.New("instance policy unavailable")
