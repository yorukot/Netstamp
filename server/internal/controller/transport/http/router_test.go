...
func TestNewRouterServesOpenAPIWithoutRuntimeServices(t *testing.T) {
	...
	assertOpenAPIOperation(t, spec, http.MethodGet, "/auth/methods", "getAuthMethods")
	assertOpenAPIOperation(t, spec, http.MethodGet, "/auth/oidc/start", "startOIDC")
	assertOpenAPIOperation(t, spec, http.MethodGet, "/auth/oidc/callback", "completeOIDC")
	assertOpenAPIOperation(t, spec, http.MethodGet, "/auth/sudo", "getSudoStatus")
	assertOpenAPIOperation(t, spec, http.MethodPost, "/auth/sudo/password", "reauthenticatePassword")
	...
	assertOpenAPIOperation(t, spec, http.MethodPut, "/users/me/password", "setCurrentUserPassword")
	assertOpenAPIOperation(t, spec, http.MethodDelete, "/users/me/password", "removeCurrentUserPassword")
	assertOpenAPIOperation(t, spec, http.MethodGet, "/users/me/authentication-methods", "listCurrentUserAuthenticationMethods")
