...
func TestNewRouterProtectedRoutesRequireSessionCookie(t *testing.T) {
	...
	for _, route := range []struct {
		...
		{method: http.MethodGet, path: "/api/v1/projects/vector-ix/public-pages"},
		{method: http.MethodPost, path: "/api/v1/projects/vector-ix/public-pages"},
		{method: http.MethodGet, path: "/api/v1/projects/vector-ix/public-pages/page-1"},
		{method: http.MethodPatch, path: "/api/v1/projects/vector-ix/public-pages/page-1"},
		{method: http.MethodDelete, path: "/api/v1/projects/vector-ix/public-pages/page-1"},
		{method: http.MethodPost, path: "/api/v1/projects/vector-ix/public-pages/page-1/folders"},
		{method: http.MethodPatch, path: "/api/v1/projects/vector-ix/public-pages/page-1/folders/folder-1"},
		{method: http.MethodDelete, path: "/api/v1/projects/vector-ix/public-pages/page-1/folders/folder-1"},
