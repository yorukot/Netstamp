...
type checkTracerouteConfigInput struct {
	Protocol        *string `json:"protocol,omitempty" enum:"icmp,udp,tcp" doc:"Traceroute protocol." example:"icmp"`
	...
	PacketSizeBytes *int32  `json:"packetSizeBytes,omitempty" minimum:"0" maximum:"65507" doc:"Probe payload size in bytes." example:"56"`
	Port            *int32  `json:"port,omitempty" minimum:"1" maximum:"65535" doc:"Destination port for UDP/TCP traceroute." example:"33434"`
