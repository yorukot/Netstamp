...
func (h *Handler) handleListNotifications(w http.ResponseWriter, r *http.Request) {
	...
	writeJSONOrProblem(w, r, http.StatusOK, map[string]any{"notifications": notificationResponses(notifications, h.emailSMTPConfigured(r.Context()))}, err)
}
...
func (h *Handler) handleCreateNotification(w http.ResponseWriter, r *http.Request) {
	...
	writeJSONOrProblem(w, r, http.StatusCreated, map[string]any{"notification": notificationResponse(notification, h.emailSMTPConfigured(r.Context()))}, err)
}
...
func (h *Handler) handleGetNotification(w http.ResponseWriter, r *http.Request) {
	...
	writeJSONOrProblem(w, r, http.StatusOK, map[string]any{"notification": notificationResponse(notification, h.emailSMTPConfigured(r.Context()))}, err)
}
