...
- `internal/controller/application/auth/`, `internal/controller/application/project/`, `internal/controller/application/label/`, `internal/controller/application/check/`, `internal/controller/application/probe/`, `internal/controller/application/result/{ping,tcp,traceroute,measurement,shared}/`, `internal/controller/application/publicpage/`, `internal/controller/application/proberuntime/`, and `internal/controller/application/pingquery/`: controller use cases, ports, DTOs, errors, shared query policy, and feature orchestration. `internal/controller/application/result/` itself is a thin compatibility facade for HTTP wiring.
