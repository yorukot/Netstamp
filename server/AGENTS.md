...
- `internal/controller/transport/http/handler/install/`: unauthenticated Linux probe install assets. It serves the systemd installer script, uninstaller script, and the Linux amd64 agent binary built into the backend image.
