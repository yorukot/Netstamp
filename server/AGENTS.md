...
Do not add narrow storage input types when existing domain models already express the data cleanly. If a repository needs persistence-specific translation, keep it inside the repository implementation rather than introducing another domain DTO solely for storage plumbing.
