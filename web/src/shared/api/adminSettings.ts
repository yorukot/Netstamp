...
export type AdminUpdateSettings = components["schemas"]["AdminUpdateSettings"];
export type AdminUpdateSettingsPatch = components["schemas"]["AdminUpdateSettingsPatch"];
export type AdminUpdateStatus = components["schemas"]["AdminUpdateStatus"];
