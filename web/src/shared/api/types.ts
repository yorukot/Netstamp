...
export type ApiAuthenticationMethods = components["schemas"]["AuthenticationMethodsResponse"];
export type PasswordSudoInput = components["schemas"]["PasswordSudoRequest"];
...
export type CreateEmailVerificationInput = components["schemas"]["CreateEmailVerificationRequest"];
export type GrantSystemAdminInput = components["schemas"]["GrantSystemAdminRequest"];
export type CreatePasswordResetInput = components["schemas"]["CreatePasswordResetRequest"];
