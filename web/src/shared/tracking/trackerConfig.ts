...
export const trackerConfig = normalizeTrackerConfig({
	googleTagId: import.meta.env.VITE_NETSTAMP_GOOGLE_TAG_ID,
	gaMeasurementId: import.meta.env.VITE_NETSTAMP_GA_MEASUREMENT_ID,
	clarityProjectId: import.meta.env.VITE_NETSTAMP_CLARITY_PROJECT_ID,
	metaPixelId: import.meta.env.VITE_NETSTAMP_META_PIXEL_ID,
	facebookPixelId: import.meta.env.VITE_NETSTAMP_FACEBOOK_PIXEL_ID,
